...
> Fichier de référence global pour Agent. Toujours consulter ce fichier avant de commencer une tâche.
...
Chaque fichier agent couvre un domaine précis. Agent (Antigravity/Gemini) doit charger uniquement les fichiers pertinents à la tâche en cours.

```
.agent/
├── project-context.md           ← CE FICHIER — vision globale, stack, conventions
├── rules/
